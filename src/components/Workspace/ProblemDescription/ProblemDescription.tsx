...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({problem, _solved}) => {
    ...
    const { currentProblem, loading, problemDifficultyClass, setCurrentProblem } = userGetCurrentProblem(problem.id);
                        ...
                        {problem.examples.map((example,index) => (
                             ...
                             <div className='example-card'>
                                 <pre>
                                     ...
                                     {example.explanation && (
                                         <>
                                         <strong>Exaplanation:</strong> {example.explanation}
                                         </>
                                     )}
                                 </pre>
                             </div>
...
function userGetCurrentProblem(problemId:string) {
